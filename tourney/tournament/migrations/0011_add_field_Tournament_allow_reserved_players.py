...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournament.allow_reserved_players'
        db.add_column(u'tournament_tournament', 'allow_reserved_players',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tournament.allow_reserved_players'
        db.delete_column(u'tournament_tournament', 'allow_reserved_players')
    ...
    models = {
        ...
        u'tournament.registrationstage': {
            'Meta': {'ordering': "['opens']", 'object_name': 'RegistrationStage'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'tournament.tournament': {
            ...
            'allow_reserved_players': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'tournament.tournamentplayer': {
            ...
            'paypal_payer_id': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
