...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TournamentPlayer.paypal_payment_id'
        db.add_column(u'tournament_tournamentplayer', 'paypal_payment_id',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TournamentPlayer.is_pending_payment'
        db.add_column(u'tournament_tournamentplayer', 'is_pending_payment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TournamentPlayer.paypal_payment_id'
        db.delete_column(u'tournament_tournamentplayer', 'paypal_payment_id')

        # Deleting field 'TournamentPlayer.is_pending_payment'
        db.delete_column(u'tournament_tournamentplayer', 'is_pending_payment')
    ...
    models = {
        ...
        u'tournament.tournamentplayer': {
            ...
            'is_pending_payment': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'paypal_payment_id': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
