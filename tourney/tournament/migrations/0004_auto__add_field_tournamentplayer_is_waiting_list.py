...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TournamentPlayer.is_waiting_list'
        db.add_column(u'tournament_tournamentplayer', 'is_waiting_list',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TournamentPlayer.is_waiting_list'
        db.delete_column(u'tournament_tournamentplayer', 'is_waiting_list')
