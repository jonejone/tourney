...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournament.paypal_client_id'
        db.add_column(u'tournament_tournament', 'paypal_client_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tournament.paypal_secret'
        db.add_column(u'tournament_tournament', 'paypal_secret',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tournament.paypal_mode'
        db.add_column(u'tournament_tournament', 'paypal_mode',
                      self.gf('django.db.models.fields.CharField')(default='live', max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tournament.paypal_client_id'
        db.delete_column(u'tournament_tournament', 'paypal_client_id')

        # Deleting field 'Tournament.paypal_secret'
        db.delete_column(u'tournament_tournament', 'paypal_secret')

        # Deleting field 'Tournament.paypal_mode'
        db.delete_column(u'tournament_tournament', 'paypal_mode')
    ...
    models = {
        ...
        u'tournament.tournament': {
            ...
            'enable_payments': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'paypal_client_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'paypal_mode': ('django.db.models.fields.CharField', [], {'default': "'live'", 'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'paypal_secret': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'null': 'True', 'blank': 'True'}),
