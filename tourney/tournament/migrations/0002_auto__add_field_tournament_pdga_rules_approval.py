...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournament.pdga_rules_approval'
        db.add_column(u'tournament_tournament', 'pdga_rules_approval',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tournament.pdga_rules_approval'
        db.delete_column(u'tournament_tournament', 'pdga_rules_approval')
