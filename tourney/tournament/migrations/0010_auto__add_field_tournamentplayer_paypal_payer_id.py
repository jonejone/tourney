...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TournamentPlayer.paypal_payer_id'
        db.add_column(u'tournament_tournamentplayer', 'paypal_payer_id',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TournamentPlayer.paypal_payer_id'
        db.delete_column(u'tournament_tournamentplayer', 'paypal_payer_id')
