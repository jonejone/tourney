...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournament.registration_info'
        db.add_column(u'tournament_tournament', 'registration_info',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tournament.registration_info'
        db.delete_column(u'tournament_tournament', 'registration_info')
