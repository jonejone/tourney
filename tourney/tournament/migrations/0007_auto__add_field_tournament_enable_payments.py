...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournament.enable_payments'
        db.add_column(u'tournament_tournament', 'enable_payments',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tournament.enable_payments'
        db.delete_column(u'tournament_tournament', 'enable_payments')
