...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournament.max_players'
        db.add_column(u'tournament_tournament', 'max_players',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=72),
                      keep_default=False)

        # Adding field 'Tournament.wildcard_spots'
        db.add_column(u'tournament_tournament', 'wildcard_spots',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tournament.max_players'
        db.delete_column(u'tournament_tournament', 'max_players')

        # Deleting field 'Tournament.wildcard_spots'
        db.delete_column(u'tournament_tournament', 'wildcard_spots')
