...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TournamentOption.is_available'
        db.add_column(u'tournament_tournamentoption', 'is_available',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TournamentOption.is_available'
        db.delete_column(u'tournament_tournamentoption', 'is_available')
