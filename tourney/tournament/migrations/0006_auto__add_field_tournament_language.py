...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournament.language'
        db.add_column(u'tournament_tournament', 'language',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tournament.language'
        db.delete_column(u'tournament_tournament', 'language')
